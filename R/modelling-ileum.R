...
shrinkage <- c(RNAseq = 0.360116796197683, Micro = 0.543260440351768, 1) #Calculated from the server for the data derived from original data
...
saveRDS(out, "output/models0_ileum.RDS")
...
saveRDS(out, "output/models2_ileum.RDS")
...
saveRDS(out, "output/models3_ileum.RDS")
