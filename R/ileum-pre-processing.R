...
OTUs2 <- norm_RNAseq(OTUs2[, meta5$Exact_location == "ileum"])
...
stopifnot(sum(meta5$Original == colnames(OTUs2)) == 43)
stopifnot(sum(meta5$Original == colnames(rna2)) == 43)
...
saveRDS(A, "data/RGCCA_ileum_data.RDS")
