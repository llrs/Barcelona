...
saveRDS(out_model, "model2_colon_optimization.RDS")
out2 <- readRDS("model2_colon_optimization.RDS")
...
saveRDS(model1.1_sgcca, "model1.1_colon_sgcca.RDS")
...
saveRDS(out_model, "model2_colon_optimization_IBD.RDS")
out2 <- readRDS("model2_colon_optimization_IBD.RDS")
...
saveRDS(model2b2_sgcca, "model2b2_colon_sgcca.RDS")
