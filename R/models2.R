...
# shrinkage[1:2] <- vapply(Ab[1:2], tau.estimate, numeric(1L)) # c(0.322297910454825, 0.578751235707392)

shrinkage[1:2] <- c(0.322297910454825, 0.578751235707392)
...
saveRDS(out_model, "data_out/model2_optimization.RDS")
out2 <- readRDS("data_out/model2_optimization.RDS")
...
saveRDS(model1.1_sgcca, "data_out/model1.1_sgcca.RDS")
...
saveRDS(out_model, "data_out/model2_optimization_IBD.RDS")
out2 <- readRDS("data_out/model2_optimization_IBD.RDS")
