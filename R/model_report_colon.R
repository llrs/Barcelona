...
models0 <- readRDS("output/models0_colon.RDS")
model0 <- models0[[1]]
model0i <- models0[[2]]
models2 <- readRDS("output/models2_colon.RDS")
model1 <- models2[[1]]
model1i <- models2[[2]]
model2 <- models2[[3]]
model2i <- models2[[4]]
...
model2_best <- readRDS("output/model2b_colon_sgcca.RDS") # Best according to antiTNF
models3 <- readRDS("output/models3_colon.RDS")
model3 <- models3[[1]]
model3i <- models3[[2]]
# bests according to TRIM
...
model3_best <- readRDS("output/model3_colon_best.RDS") # Best according to antiTNF
