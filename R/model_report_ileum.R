...
models0 <- readRDS("models0_ileum.RDS")
model0 <- models0[[1]]
model0i <- models0[[2]]
models2 <- readRDS("models2_ileum.RDS")
model1 <- models2[[1]]
model1i <- models2[[2]]
model2 <- models2[[3]]
model2i <- models2[[4]]
...
model2_best <- readRDS("model2b_ileum_sgcca.RDS") # Best according to antiTNF
models3 <- readRDS("models3_ileum.RDS")
model3 <- models3[[1]]
model3i <- models3[[2]]
# bests according to TRIM
...
model3_best <- readRDS("model3_ileum_best.RDS") # Best according to antiTNF
