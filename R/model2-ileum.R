...
saveRDS(out_model, "model2_ileum_optimization.RDS")
out2 <- readRDS("model2_ileum_optimization.RDS")
...
saveRDS(model2b_sgcca, "model2b_ileum_sgcca.RDS")
...
saveRDS(model1.1_sgcca, "model1.1_ileum_sgcca.RDS")
...
saveRDS(out_model, "model2_ileum_optimization_IBD.RDS")
out2 <- readRDS("model2_ileum_optimization_IBD.RDS")
...
saveRDS(model2b2_sgcca, "model2b2_ileum_sgcca.RDS")
